...
if __name__ == "__main__":
    ...
    np.savez(
        os.path.join(test_dir, f"test_input_{fps}fps.npz"), clips=test_ctrl
    )
    copyfile(
        os.path.join(processed_dir, f"data_pipe_{fps}fps.sav"),
        os.path.join(test_dir, f"data_pipe_{fps}fps.sav"),
    )
    copyfile(
        os.path.join(processed_dir, "input_scaler.sav"),
        os.path.join(test_dir, "input_scaler.sav"),
    )
    copyfile(
        os.path.join(processed_dir, "output_scaler.sav"),
        os.path.join(test_dir, "output_scaler.sav"),
    )
